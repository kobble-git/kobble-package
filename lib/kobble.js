...
let packageDir = atom.packages.getPackageDirPaths()[0];
let noderedDir = path.join(packageDir, "kobble-pipelines");//"D:/node-red";//
console.log("kobble-pipelines:" + noderedDir);
...
openers.addOpener(".kob", (ext, ele, uri) => new KobbleOpener(uri, ele));
