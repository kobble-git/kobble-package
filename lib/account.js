...
let productDescs = {
  kobble : {
    "title" : "Kobble",
    "desc" : "Automation with Pipelines"
  }
}
...
class AccountComponent extends Component {
  ...
  render() {
    ...
    let account = profile.profile ? profile.profile.account : {};
    let products = profile.customData ? profile.customData.customData.products : [];
    ...
    return (
      <div className="account-container">
        ...
        <div>
          <div className="account-section" style={otherStyle}>
            ...
            {_.map(products, (product, i) => {
              return (
                <div key={i} className="kobble-product">
                  {productDescs[product.name].title} - {productDescs[product.name].desc}
                </div>
              )
            })}
          </div>
          <div className="account-section" style={registerStyle}>
            ...
            <TextField type="password" style={passwordStyle} errorStyle={errorStyle} errorText={this.props.account.get(PasswordTextError)} value={this.props.account.get(AccountPassword)} hintText="Enter Password" fullWidth={true} onChange={(e) => this.handleChange(e, AccountPassword)}/>
            <TextField type="password" style={passwordStyle} errorStyle={errorStyle} errorText={this.props.account.get(PasswordConfirmTextError)} value={this.props.account.get(AccountConfirmPassword)} hintText="Confirm Password" fullWidth={true} onChange={(e) => this.handleChange(e, AccountConfirmPassword)}/>
          ...
          <div className="account-section" style={loginStyle}>
